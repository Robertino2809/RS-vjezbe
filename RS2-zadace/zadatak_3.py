...
# Rječnik - ključevi brojevi 50-500
korijeni = {x: round(x**0.5, 2) for x in range(50, 501, 50)}
print(korijeni)

# Lista rječnika - prezime - zbroj bodova
studenti = [
...
# Rječnik broj 1-10 - lista faktorijela do tog broja
import math
